...
public class NextActivity3 extends AppCompatActivity {
    ...
    public void appointment(View v) {
        ...
        Intent i = new Intent(NextActivity3.this, NextActivity.class);
        startActivity(i);

    }

    public void adhoc(View v) {
        db = new DBOperation(NextActivity3.this);

        if (db.getadhocdetails(db).size() == 0) {
            Intent i = new Intent(NextActivity3.this, adhocremainder.class);
            startActivity(i);


        } else {

            Intent i = new Intent(NextActivity3.this, Nextactivity1.class);
            startActivity(i);
        }
    }
    ...
    public void witness(View v) {
        ...
        if (db.getWitnessdetails(db).size() == 0) {
            ...
            Intent i = new Intent(NextActivity3.this, NextActivity2.class);
            startActivity(i);
        }
    }
            ...
            case R.id.action_refresh:
                ...
                if (GenericMethods.isConnected(getApplicationContext())) {
                    ...
                    if (listofcommment.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, SendCommentService.class);
                        startService(intent);
                        flag = true;
                    ...
                    if (acvrreportlist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, SendReportService.class);
                        startService(intent);
                        flag = true;
                    }
                    if (statusreportlist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, StatusReportService.class);
                        startService(intent);
                        flag = true;
...
//                    System.out.println("paymentlist size:"+paymentlist.size());
                    if (paymentlist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, SendPaymentService.class);
                        startService(intent);
                        flag=true;
                    }
//
...
//                    System.out.println("partieslistsize:" + partieslist.size());
                    if (partieslist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, SendmultiPartyReport.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (appointmentlist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, postappointmentbooking.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (calllist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, call.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (reschedulelist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, rescheduledetails.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (fetchactualtimelist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, fetchactualtime.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (posttasklist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, Posttask.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (notassignlist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, not_applicablepost.class);
                        startService(intent);
                        flag=true;
                    }
                    ...
                    if (reassignlist.size() > 0) {
                        Intent intent = new Intent(NextActivity3.this, reassignpost.class);
                        startService(intent);
                        flag=true;
                    }
                    if (flag) {
                        AlertDialog alertDialog = new AlertDialog.Builder(NextActivity3.this).create();
                        ...
                        pDialog = new ProgressDialog(NextActivity3.this);
...
//            case R.id.weekend:
//                Intent i2 = new Intent(NextActivity3.this, weekendoff.class);
//                startActivity(i2);
//                this.finish();
//                return true;
